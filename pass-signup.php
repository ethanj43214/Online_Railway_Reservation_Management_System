      ...
      <div class="be-content">
        <div class="main-content container-fluid">
          <div class="splash-container">
              ...
              <!--Login Form-->
                <form method ="POST">
                  <div class="login-form">
                    ...
                    <div class="form-group">
                      <input class="form-control" name="cpass_pwd" type="password" placeholder="Confirm Password">
                    </div>
            ...
            <div class="splash-footer">&copy; 2024 Online Railway Reservation System<br>Developed By Naman | Om | Vinit | Ethan</div>
